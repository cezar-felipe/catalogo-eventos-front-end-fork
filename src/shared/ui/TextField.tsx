  ...
  return (
    <div className={`flex flex-col gap-1 text-sm ${containerClassName}`}>
      ...
      <input
        ...
        aria-invalid={!!error}
        className={`rounded-xl border-blue-500 px-3 py-2 outline-none bg-white/10 border-white/20 focus:border-[#20aa4b] focus:ring-2 focus:ring-[#20aa4b]/60 ${className}`}
        {...rest}
      />
      {hint && !error && (
